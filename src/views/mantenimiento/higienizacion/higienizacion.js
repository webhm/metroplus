...
const IntegracionHigienizacion = {
    ...
    oninit: () => {
        ...
        IntegracionHigienizacion.searchField = "";
        IntegracionHigienizacion.showBusquedas = "";
        IntegracionHigienizacion.mensajes = [];
        App.isAuth();
    },
    oncreate: () => {
        document.title = "Integración de Higienización | " + App.title;
        IntegracionHigienizacion.fetchUltimasBusquedas();
                ...
                m("div.container", [
                    ...
                    m("div.row.tx-14", [
                                ...
                                m("div.col-sm-12.pd-b-10.mg-b-10", [
                                    ...
                                    m("div.mg-b-5.d-flex", [
                                        m("div.custom-control.custom-radio.mg-r-15", [
                                            m("input.custom-control-input[type='radio'][id='cc'][name='tipoBusqueda'][value='cc']", {
                                                onclick: (e) => {
                                                    if (e.target.checked) {
                                                        IntegracionHigienizacion.tipoBusqueda = e.target.value;
                                                    }
                                                }
                                            }),
                                    ...
                                    m("div.mg-t-15.input-group", [
                                        m("input.form-control.mg-b-20.wd-100p[placeholder='Buscar por NHC o Nombres y Apellidos completos del Paciente'][title='Buscar'][type='text']", {
                                            oninput: (e) => {
                                                IntegracionHigienizacion.searchField = e.target.value.toUpperCase();
                                            },
                                            value: IntegracionHigienizacion.searchField
                                        }),
                                        m("div.input-group-append",
                                            m("button.btn.btn-outline-light[type='button']", {
                                                onclick: () => {
                                                    IntegracionHigienizacion.fetchPacientes();
                                                }
                                            }, [
                        ...
                        m("div.table-loader.col-12.wd-100p", {
                            class: IntegracionHigienizacion.showProcess,
                        },
                        ...
                        m("div.col-12", {
                            class: IntegracionHigienizacion.showPacientes,
                        }, [

                            m("div.table-content.col-12.pd-r-0.pd-l-0.pd-b-20.",
                                m("table.table.table-sm[id='table-higienizacion'][width='100%']"),
                            )
                        ])
                    ]),
                ])
...
function loadPacientes() {
    ...
    var table = $("#table-higienizacion").DataTable({
        data: IntegracionHigienizacion.mensajes,
        responsive: false,
        dom: 'ltp',
        language: {
