...
const Evoluciones = {
    ...
    fetch: () => {
        ...
        m.request({
                ...
                body: {
                    numeroHistoriaClinica: PedidoLISA.data.CD_PACIENTE + '01'
                },
                headers: {
                    "Authorization": localStorage.accessToken,
                },
        ...
        m.request({
            ...
            .then(function(result) {
                if (result.status) {
                    ...
                    PedidoLISA.data = result.data;
                    PedidoLISA.examenes = result.examenes;
                    Evoluciones.fetch();
                } else {
