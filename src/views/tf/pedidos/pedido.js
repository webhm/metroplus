                    ...
                    return [
                        ...
                        m("table.table.table-bordered.wd-100p", {
                            ...
                            m("tbody", [
                                ...
                                m("tr", [
                                    m("th[colspan='6'][scope='row'][width='50%']", { "style": { "padding": "0", "background-color": "#eef9c8" } },
                                        m("div.m-0.p-0.tx-bold.text-center.",
                                            "1.- EVOLUCIÓN"
                                        )
                                    ),
                                    m("th[colspan='5'][scope='row'][width='50%']", { "style": { "padding": "0", "background-color": "#eef9c8" } },
                                        m("div.m-0.p-0.tx-bold.text-center.",
                                            "2.- PRESCRIPCIONES"
                                        )
                                    ),
...
const Evoluciones = {
    ...
    fetch: () => {
        ...
        m.request({
                ...
                body: {
                    numeroHistoriaClinica: PedidoTF.data.CD_PACIENTE + '01'
                },
                headers: {
                    "Authorization": localStorage.accessToken,
                },
...
const Examenes = {
    ...
    view: () => {
        ...
        if (PedidoTF.examenes.length !== 0) {
            return PedidoTF.examenes.map(function(_val, _i, _contentData) {
                return [
...
const PedidoTF = {
    ...
    oninit: (_data) => {
        ...
        if (_data.attrs.numeroPedido !== undefined) {
            ...
            if (PedidoTF.data !== undefined && PedidoTF.data.length == 0) {
                PedidoTF.numeroPedido = _data.attrs.numeroPedido;
                PedidoTF.numeroAtencion = _data.attrs.numeroAtencion;
                PedidoTF.numeroHistoriaClinica = _data.attrs.numeroHistoriaClinica;
                PedidoTF.fetch();
            } else {
                if (PedidoTF.numeroPedido !== _data.attrs.numeroPedido) {
                    PedidoTF.numeroPedido = _data.attrs.numeroPedido;
                    PedidoTF.numeroAtencion = _data.attrs.numeroAtencion;
                    PedidoTF.numeroHistoriaClinica = _data.attrs.numeroHistoriaClinica;
                    PedidoTF.fetch();
    ...
    fetch: () => {
        PedidoTF.data = [];
        PedidoTF.loader = true;
        m.request({
                method: "POST",
                url: "https://api.hospitalmetropolitano.org/t/v1/status-pedido-tf",
                body: {
                    numeroPedido: PedidoTF.numeroPedido,
                },
                headers: {
            ...
            .then(function(result) {
                if (result.status) {
                    PedidoTF.loader = false;
                    PedidoTF.data = result.data;
                    PedidoTF.examenes = result.examenes;
                    Evoluciones.fetch();
                } else {
                    PedidoTF.error = result.message;
                }
    ...
    view: (_data) => {
        ...
        return [
            ...
            m(SidebarTF, { oncreate: SidebarTF.setPage(24) }),
            m("div.content.content-components",
                m("div.container.mg-l-0.mg-r-0", {
                    ...
                    m("h1.df-title.mg-t-20.mg-b-10",
                        "Detalle de Pedido N°: " + PedidoTF.numeroPedido
                    ),
                                            ...
                                            m("tbody", [
                                                ...
                                                m("tr", [
                                                    ...
                                                    m("td[colspan='4']", {
                                                        ...
                                                        PedidoTF.data.SECTOR + " " + PedidoTF.data.UBICACION
                                                    ),
