...
const actions = {
    ...
    increment(model) {
        ...
        }<a id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="false" class="nav-link" style="color: rgb(71, 107, 163);"><i class="fas fa-file-alt pd-1 mg-r-2"></i> HOJA 005</a>
        m.redraw();
    },
