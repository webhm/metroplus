...
const Evoluciones = {
    ...
    fetch: () => {
        ...
        m.request({
            ...
            body: {
                numeroHistoriaClinica: RecetaFarmacia.data.CD_PACIENTE + '01'
            },
            headers: {
                "Authorization": localStorage.accessToken,
            },
...
const Examenes = {
    ...
    view: () => {
        ...
        if (RecetaFarmacia.medicamentos.length !== 0) {
            return RecetaFarmacia.medicamentos.map(function (_val, _i, _contentData) {
                return [
                    m('.tx-14.tx-semibold.d-inline', _val.MEDICACION + " (" + _val.CANT + ")"),
                    m('br'),
...
const RecetaFarmacia = {
    ...
    view: (_data) => {
        ...
        return [
            ...
            m(SidebarFarma, { oncreate: SidebarFarma.setPage(26) }),
                                            ...
                                            m("tbody", [
                                                ...
                                                m("tr", [
                                                    ...
                                                    m("td[colspan='3']", {
                                                        ...
                                                        RecetaFarmacia.data.ESPECIALIDAD
                                                    ),
