            ...
            return [
                m("div.bg-white.bd.d-flex.flex-column.justify-content-end", [
                    ...
                    m("p.mg-5.tx-right", [
                        ...
                        m("button.btn.btn-xs.btn-primary.tx-semibold.mg-r-5[type='button']", {
                                class: RecepMuestras.disabledToma ? "" : "d-none",
                                onclick: () => {
                                    RecepMuestras.disabledToma = false;
                        ...
                        m("button.btn.btn-xs.btn-outline-secondary.tx-semibold[type='button']", {
                                onclick: () => {
                                        ...
                                        StatusPedido.dataMuestras.map(function(_val, _i, _contentData) {
                                            ...
                                            return [
                                                m("tr", [
                                                    ...
                                                    m("td.tx-18.tx-medium.text-left",
                                                        _val.NM_EXA_LAB + (StatusPedido.dataMuestras[_i]['NUEVO_PEDIDO'] !== undefined && StatusPedido.dataMuestras[_i]['NUEVO_PEDIDO'] == true ? " (Nuevo pedido) " : "")
                                                    ),
                                                            ...
                                                            m("input.custom-control-input.tx-16[type='checkbox'][id='r_" + _val.CD_EXA_LAB + "']", {
                                                                ...
                                                                onclick: function(e) {
                                                                    ...
                                                                    if (p) {
                                                                        ...
                                                                        this.checked = true;
                                                                        if (ControlLISA.nuevoPedido) {
                                                                            StatusPedido.dataMuestras[_i]['NUEVO_PEDIDO'] = true;
                                                                        }
                                                                        StatusPedido.dataMuestras[_i]['STATUS_RECEP'] = "1";
                                        ...
                                        m("tr", [
                                            ...
                                            m("th.text-right[colspan='2']",
                                                m("select.custom-select.wd-30p.tx-semibold", {
                                                    ...
                                                    disabled: (Object.keys(ControlLISA.logsEnvio).length !== 0 ? "disabled" : ""),
