...
const NotificacionesPendientesLab = {
    dataPendientesAlta: [],
    dataSoloGema: [],
    dataGemaMV: [],
    dataFiltros: [],
    ...
    fetch: () => {
        m.request({
            ...
            .then(function(result) {
                ...
                loadNotificacionesPendientesLab();
    ...
    oninit: (_data) => {
        HeaderPrivate.page = "";
        SidebarLab.page = "";
        NotificacionesPendientesLab.dataPendientesAlta = [];
        NotificacionesPendientesLab.dataCamaTotales = [];
        NotificacionesPendientesLab.camasTotales = 0;
        NotificacionesPendientesLab.pendienteAlta = 0;
...
function loadNotificacionesPendientesLab() {
...
export default NotificacionesPendientesLab;